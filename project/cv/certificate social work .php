...
<body>
    ...
    <form>
        ...
        <div id="add_err2"></div>
        <div id="errMsg"></div>
        <h1>Certificate in Social work&Community Development</h1>
     ...
     passValues();
       ...
       nextPage();
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D you cannot take certificate in Social Work and Community Development</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt==" "){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C you cannot take diploma in  Project Management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D- you cannot take certificate in Social Work and Community Development</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade E you cannot take certificate in Social Work and Community Development</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
