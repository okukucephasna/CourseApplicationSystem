...
<body>
    ...
    <form>
        ...
        <div id="errMsg"></div>
        <h1>Certificate in Criminology & Criminal Justice</h1>
...
<a href="../work4.php" class="btn btn-danger" id="prev-2">Previous</a>
...
<small>To go back to the previous page click on the previous button</small>
     ...
     passValues();
       ...
       nextPage();
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D you cannot take Certificate in Criminology and Criminal Justice</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt==" "){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C you cannot take  Certificate in Criminology and Criminal Justice</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D- you cannot take  Certificate in Criminology and Criminal Justice</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade E you cannot take  Certificate in Criminology and Criminal Justice</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
    ...
    <!-- <a href="../3.php" class="btn btn-danger" id="prev-2">Previous</a>
