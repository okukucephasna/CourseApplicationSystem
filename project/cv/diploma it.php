     ...
     passValues();
       ...
       nextPage();
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C- in Math you cannot take bachelor of Information Technology</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D+'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D+ in Math you cannot take diploma in Information Technology</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D in Math you cannot take diploma in Information Technology</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C you in Math cannot take diploma in Information Technology</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D- in Math you cannot take diploma in Information Technology</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade E in Math you cannot take diploma in Information Technology</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
