...
<body>
    ...
    <form>
        ...
        <div id="add_err2"></div>
        <div id="errMsg"></div>
        <h1>Diploma in Business Management Options</h1>
        <label>Select Your English/Kiswahili/Buiness Grade:</label>
    ...
    $('.drpselecttext').change(function(){
     ...
     nextPage();
       ...
       nextPage();
        ...
        <strong>With grade C- in English/Kiswahili you cannot take diploma in business management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D+'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade D+ in English/Kiswahili you cannot take diploma in business management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade E in English/Kiswahili you cannot take diploma in business management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade D- in English/Kiswahili you cannot take diploma in business management</strong>,thank you for visiting . \ \
