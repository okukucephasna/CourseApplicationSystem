...
<body>
    ...
    <form>
        ...
        <div id="add_err2"></div>
        <div id="errMsg"></div>
        <h1>Diploma in Public Relations and Creative advertising</h1>
    ...
    $('.drpselecttext').change(function(){
     ...
     passValues();
       ...
       nextPage();
        ...
        <strong>With grade C- in English/Kiswahili you cannot take diploma in public relations and creative advertising</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D+'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade D+ in English/Kiswahili you cannot take diploma in public relations and creative advertising</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade D in English/Kiswahili you cannot take diploma in public relations and creative advertising</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
        <strong>With grade E in English/Kiswahili you cannot take diploma in public relations and creative advertising</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
