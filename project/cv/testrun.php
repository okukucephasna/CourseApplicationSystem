     ...
     passValues();
       ...
       nextPage();
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C you cannot take bachelor of Social work</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='C-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C- you cannot take bachelor of Social Work</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D+ you cannot take bachelor of Social Work</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D you cannot take bachelor of Social Work</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade E you cannot take bachelor of Social Work</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
