...
<body>
    ...
    <form>
        ...
        <div id="add_err2"></div>
        <div id="errMsg"></div>
        <h1>Certificate in Business Management</h1>
        <label>Select English/Kiswahili Grade:</label>
     ...
     passValues();
       ...
       nextPage();
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D you cannot take Certificate in Business Management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt==" "){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade C you cannot take Certificate in Business Management</strong>,thank you for visiting . \ \
                                </div>');
    }else if(myselectedtxt=='D-'){
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade D- you cannot take Certificate in Business Management</strong>,thank you for visiting . \ \
        ...
        $("div#errMsg").html('<div class="alert alert-danger"> \
                                <strong>With grade E you cannot take Certificate in Business Management</strong>,thank you for visiting . \ \
                                </div>');
    }
  	});
}); 
