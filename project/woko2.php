...
<small>To go back to the previous page click on the previous button</small>
    ...
    <script type="text/javascript">
        ...
        window.location.href="cv/bachelor of criminology.php";
       }
     function commerce(){
        var firstname = "bachelor of commerce";
        localStorage.setItem("textvalue",firstname);
        window.location.href="cv/bachelor of commerce.php";
       }
       function dmip(){
        var firstname = "bachelor of Disaster Management";
        localStorage.setItem("textvalue",firstname);
        window.location.href="cv/bachelor of dmip.php"; 
       }
    function arts(){
        var firstname = "bachelor of Education(arts)";
        localStorage.setItem("textvalue",firstname);
        window.location.href="cv/bachelor of Education(arts).php";
       }
    function economics(){
        var firstname = "bachelor of science(Economics)";
        localStorage.setItem("textvalue",firstname);
           window.location.href="cv/bachelor of science(Economics).php";
       }
     function IT(){
        var firstname = "bachelor of science(Information Technology)";
        localStorage.setItem("textvalue",firstname);
           window.location.href="cv/bachelor of science(Information Technology).php";
       }
         function social(){
            var firstname = "bachelor of Social Work";
        localStorage.setItem("textvalue",firstname);
        window.location.href="cv/bachelor of social work.php";
